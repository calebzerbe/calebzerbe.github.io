...
<div class="text-center pe-4">
  <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center">
    <div style="margin: 5px">
      <img style="height:auto; min-height: 150px; max-height:600px" src="../img/E28_Coding_Standards_Essay_Image_BeforeESLintFix.png">
      <p style="text-align: center;">My Typescript Before ESLint Fixes</p>
    </div>
    <div style="margin: 5px">
      <img style="height:auto; min-height: 150px; max-height:600px" src="../img/E28_Coding_Standards_Essay_Image_AfterESLintFix.png">
