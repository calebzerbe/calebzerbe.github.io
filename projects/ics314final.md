...
Below I will provide some example images of the sign up page, user profile page, create sessions page, user calendar page (not the main calendar that all users can see), and the all sessions page so you can take a look at our work.
